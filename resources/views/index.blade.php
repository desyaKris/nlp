      ...
      <div class="row text-center">
        ...
        <div class="col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.5s">
            <div class="team boxed-grey">
              <div class="inner">
                <h5>Melita Dwi Nugroho (150708365)</h5>
                <p class="subtitle">Model Classification Maker and Analyzer</p>
                <div class="avatar"><img src="/ML/img/melita.jpg" alt="" class="img-responsive img-circle" /></div>
        ...
        <div class="col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.5s">
            <div class="team boxed-grey">
              <div class="inner">
                <h5>Ardian Kurniawan (150708365)</h5>
                <p class="subtitle">PPT</p>
